function [] = SingleCH_write(istorm, DAtime, Tb_file, control)
    ...
    filename_parts = [control.output_dir,'/radiance_',control.domain,'_',DAtime,'_so'];
	filename = join(filename_parts, "");  % Concatenate to single string
    disp(join(["  Output processed GOESR obs file: ", filename]));
