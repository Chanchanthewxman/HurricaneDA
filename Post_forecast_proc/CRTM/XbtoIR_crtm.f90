...
PROGRAM XbtoIR
  ...
  REAL, PARAMETER :: sat_lon = -75.2/180.0*3.14159 ! before 2017 Nov: -89.5; after: -75.2  
  INTEGER, PARAMETER :: n_ch = 1
  INTEGER, DIMENSION(n_ch) :: chlist = (/7/) ! 7: window channel
  CHARACTER(256) :: Sensor_Id = ADJUSTL('abi_g16')   
